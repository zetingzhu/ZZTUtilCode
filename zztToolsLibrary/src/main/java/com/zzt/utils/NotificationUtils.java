...
public class NotificationUtils {
     ...
     */
    public static void notify(@NonNull Context context, int id, Consumer<NotificationCompat.Builder> consumer) {
        notify(context, null, id, new ChannelConfig(context.getPackageName(), context.getPackageName(), IMPORTANCE_DEFAULT), consumer);
    }
     ...
     * @param consumer The consumer of create the builder of notification.
     */
    public static void notify(@NonNull Context context, String tag, int id, Consumer<NotificationCompat.Builder> consumer) {
        notify(context, tag, id, new ChannelConfig(context.getPackageName(), context.getPackageName(), IMPORTANCE_DEFAULT), consumer);
    }
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(@NonNull Context context, int id, ChannelConfig channelConfig, Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(@NonNull Context context, String tag, int id, ChannelConfig channelConfig, Consumer<NotificationCompat.Builder> consumer) {
     ...
     */
    public static void cancel(@NonNull Context context, String tag, final int id) {
     ...
     * @param id The identifier for the notification will be cancelled.
     */
    public static void cancel(@NonNull Context context, final int id) {
...
//                context.getPackageName(), context.getPackageName(), IMPORTANCE_DEFAULT
//        );
