 ...
 *    @Desc   :
 */
class ZFloatLayout @JvmOverloads constructor(
     ...
     * 一行最多绘制多少个
     */
    private var lineMaxChildCount = 3

    /**
     * 一行最小宽度
     */
//    private var measuredMinWidth = 0
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        // 可使用最大宽度
//        var userMaxWidth =
//            width - (paddingLeft + paddingRight + mChildHorizontalSpacing * (Math.max(
//                lineMaxChildCount - 1,
//                0
//            )))
//        // 计算最小宽度
//        measuredMinWidth = userMaxWidth * lineMaxChildCount
        ...
        if (widthSpecMode == MeasureSpec.EXACTLY) {
            ...
            for (i in 0 until count) {
                ...
                if (mItemNumberInEachLine.get(lineIndex) >= lineMaxChildCount) {
                    continue
                }
